  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final body = <String, dynamic>{
        ...
        'role': _role,
        // PocketBase auth collection flaglari:
        'verified':
            _active, // yoki 'active' / 'is_active' — sizda qaysi bo‘lsa, moslang
      };

      final createMode = widget.userId == null;

      if (_passwordCtrl.text.isNotEmpty || createMode) {
        // create holatida password majburiy
      ...
      if (createMode) {
        ...
        await ApiService.patch(
            'collections/users/records/${widget.userId}', body,
            token: token);
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(
                createMode ? 'Foydalanuvchi yaratildi' : 'Saqlab qo‘yildi')),
      );
        ...
        child: ListView(
          ...
          children: [
            ...
            SwitchListTile(
              ...
              title: const Text('Faol (verified/active)'),
              subtitle:
