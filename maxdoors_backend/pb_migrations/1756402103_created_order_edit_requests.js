...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_3176995872",
    "indexes": [
      "CREATE INDEX IF NOT EXISTS `idx_oer_order` ON `order_edit_requests` (`order`)",
      "CREATE INDEX IF NOT EXISTS `idx_oer_status` ON `order_edit_requests` (`status`)"
    ],
    "listRule": "@request.auth.id != \"\"",
    "name": "order_edit_requests",
    "system": false,
    "type": "base",
