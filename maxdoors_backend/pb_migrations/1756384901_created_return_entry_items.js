...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_3342181163",
    "indexes": [
      "CREATE INDEX IF NOT EXISTS `idx_rei_entry` ON `return_entry_items` (`entry`)",
      "CREATE INDEX IF NOT EXISTS `idx_rei_product` ON `return_entry_items` (`product`)"
    ],
    "listRule": "@request.auth.id != \"\"",
    "name": "return_entry_items",
    "system": false,
    "type": "base",
  ...
  const collection = app.findCollectionByNameOrId("pbc_3342181163");
